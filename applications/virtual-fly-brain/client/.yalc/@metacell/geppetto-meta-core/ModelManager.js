...
function loadModel(model) {
  ...
  console.time(_Resources["default"].CREATING_MODEL);
  ...
  console.time(_Resources["default"].CREATING_INSTANCES);
...
function addVariableToModel(rawModel) {
  ...
  var diffReport = _ModelFactory["default"].mergeModel(rawModel);
