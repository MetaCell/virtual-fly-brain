...
export const parseGraphResultData = data => {
    var nodes = {}, edges = {};
  ...
  export const searchChildren = (array, key, target, labels) => {
  ...
  export const sortData = (unsortedArray, key, comparator) => {
  ...
  export const convertNodes = (nodes, imagesMap) => {
    var convertedNodes = [];
    nodes.forEach((node) => {
  ...
  export const defaultComparator = (a, b, key) => {
